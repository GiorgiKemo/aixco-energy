  ...
  return (
    <main className="pt-24 lg:pt-32 min-h-screen bg-industrial-white text-industrial-black">
      <section className="px-6 pb-24 pt-16 md:py-28 max-w-7xl mx-auto">
        <div className="mb-20">
          <div className="mb-6 text-sm font-black uppercase tracking-[0.18em] text-brand-red md:text-base">Featured focus areas</div>
          ...
          {focusAreas.map((project, index) => (
            ...
            >
              ...
              <div className="min-w-0 py-4 md:col-span-5">
                <p className="text-sm font-black uppercase leading-relaxed text-zinc-500">{project.body}</p>
              </div>
              <div className="flex items-center justify-end gap-3 md:col-span-2">
                <span className="hidden text-sm font-black uppercase text-brand-red lg:inline">View on BlueRock</span>
        ...
        <div className="p-10 md:p-16 border border-zinc-800 bg-zinc-950">
          <div className="mb-8 text-sm font-black uppercase tracking-[0.18em] text-brand-red md:text-base">Investment Themes</div>
