...
export const TechSection: React.FC = () => {
  return (
    <section className="bg-zinc-950 text-industrial-white border-y border-zinc-800">
      <div className="max-w-7xl mx-auto px-6 py-32">
        <div className="max-w-3xl mx-auto text-center mb-20">
          ...
          <p className="text-zinc-400 uppercase text-xs font-black leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-px bg-zinc-800 border border-zinc-800 mb-28">
          {investmentThemes.map((theme, index) => {
            ...
            return (
              <article key={theme.title} className="bg-industrial-black p-8 min-h-[320px] flex flex-col hover:bg-zinc-900 transition-colors">
                <div className="mb-8 inline-flex h-14 w-14 items-center justify-center rounded-full bg-brand-red text-industrial-black">
                  <Icon size={24} />
                </div>
        ...
        <div id="news" className="grid grid-cols-1 lg:grid-cols-2 gap-px bg-zinc-800 border border-zinc-800">
          <div className="bg-industrial-black p-8 md:p-12">
            ...
            <p className="text-zinc-400 uppercase text-xs font-black leading-relaxed mb-8">{futureGrowth.body}</p>
